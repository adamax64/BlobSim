...
class SimData(Base):
    ...
    fire_tokens = Column(Integer, nullable=False, default=0)
    wind_tokens = Column(Integer, nullable=False, default=0)
    water_tokens = Column(Integer, nullable=False, default=0)
