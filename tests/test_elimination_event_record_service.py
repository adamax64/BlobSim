...
class TestEliminationEventRecordService(unittest.TestCase):
    ...
    def test_get_elimination_event_records_no_actions(self):
        ...
        competitors = [
            BlobCompetitorDto(id=1, name="Blob1", color="#FF0000", strength=1.0, speed=1.0),
            BlobCompetitorDto(id=2, name="Blob2", color="#00FF00", strength=1.0, speed=1.0),
            BlobCompetitorDto(id=3, name="Blob3", color="#0000FF", strength=1.0, speed=1.0)
        ]
        actions = []
    ...
    def test_get_elimination_event_records_multiple_ticks(self):
        ...
        competitors = [
            ...
            BlobCompetitorDto(id=2, name="Blob2", color="#00FF00", strength=1.0, speed=1.0),
            BlobCompetitorDto(id=3, name="Blob3", color="#0000FF", strength=1.0, speed=1.0),
            BlobCompetitorDto(id=4, name="Blob4", color="#FFFF00", strength=1.0, speed=1.0)
        ]
        ...
        actions = [
            ...
            ActionDto(blob_id=3, scores=[0.5, 0.4]),        # Won 0 ticks, eliminated after tick 2
        ...
        self.assertTrue(records[1].eliminated)  # Marked as eliminated by production logic
        ...
        self.assertTrue(records[2].eliminated)  # Marked as eliminated by production logic
        ...
        self.assertTrue(records[3].eliminated)  # Marked as eliminated by production logic
    ...
    def test_get_elimination_event_records_complex_scenario(self):
        ...
        competitors = [
            ...
            BlobCompetitorDto(id=3, name="Blob3", color="#0000FF", strength=1.0, speed=1.0),
            BlobCompetitorDto(id=4, name="Blob4", color="#FFFF00", strength=1.0, speed=1.0),
            BlobCompetitorDto(id=5, name="Blob5", color="#FF00FF", strength=1.0, speed=1.0)
        ]
