...
def get_event_records(
    ...
    if (
        ...
        return get_endurance_event_records(actions, competitors, playback_tick)
    elif event_type == EventTypeDto.SPRINT_RACE:
        return get_sprint_event_records(actions, competitors, playback_tick)
    else:
