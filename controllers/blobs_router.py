...
def get_all(
    name_search: str | None = None, show_dead: bool = False, league_id: int | None = None
) -> list[BlobStatsDto]:
    try:
        return get_all_blobs(
            name_search=name_search, show_dead=show_dead, league_id=league_id
        )
