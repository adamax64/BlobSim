...
from presentation.competition_view.utils import display_blob, display_score, get_eliminations, get_quarter_ends, is_eliminated
...
def show_quartered_high_jump_view(live: Live, event: EventDto, tick: int, field_size: int):
...
def _update_score_and_personal_best(scoreDto: ScoreDto, actual_score: int):
