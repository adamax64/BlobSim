...
def upgrade() -> None:
    ...
    op.execute('ALTER TABLE "BCS".champions ADD CONSTRAINT champions_blob_fk FOREIGN KEY (blob_id) REFERENCES "BCS".blobs(id);')
    op.execute('ALTER TABLE "BCS".champions ADD CONSTRAINT champions_league_fk FOREIGN KEY (league_id) REFERENCES "BCS".leagues(id);')
    ...
    op.execute('ALTER TABLE "BCS".grandmasters ADD CONSTRAINT grandmasters_blob_fk FOREIGN KEY (blob_id) REFERENCES "BCS".blobs(id);')
